<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="m1.aspx.cs" Inherits="project.m1" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table align="center" class="auto-style1">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="GridView1" runat="server" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" CssClass="auto-style2" ForeColor="Black" Height="219px" Width="496px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                ...
                <tr>
                    <td class="auto-style4">
                        <br />
                        Due Report<br />
                        <asp:GridView ID="GridView4" runat="server" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" CssClass="auto-style5" ForeColor="Black" Height="241px" Width="510px">
                            <FooterStyle BackColor="#CCCCCC" />
                            <HeaderStyle BackColor="Black" Font-Bold="True" ForeColor="White" />
                            <PagerStyle BackColor="#CCCCCC" ForeColor="Black" HorizontalAlign="Left" />
                            <RowStyle BackColor="White" />
