<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="billgenerate.aspx.cs" Inherits="project.billgenerate" %>
...
<body>
    ...
    <table class="auto-style12">
        <tr>
            <td class="auto-style11"><strong class="auto-style14">
                <strong>
                <asp:HyperLink ID="HyperLink1" runat="server" CssClass="auto-style7" ForeColor="#FFFF66" NavigateUrl="~/home.aspx">Home</asp:HyperLink>
                </strong>
                </strong></td>
            <td class="auto-style8"><strong class="auto-style14">
            ...
            <td class="auto-style9"><strong>
                ...
                </strong><span class="auto-style13"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong></span></td>
            <td class="auto-style10"><strong class="auto-style14">
                <asp:HyperLink ID="HyperLink5" runat="server" CssClass="auto-style7" ForeColor="#FFFF66" NavigateUrl="~/l1.aspx">Login</asp:HyperLink>
                </strong></td>
            <td class="auto-style5"><strong class="auto-style14">
        ...
        <div>
            ...
            <table align="center" class="auto-style1">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>
                        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Generate Bill" Width="200px" CssClass="auto-style15" />
                    </td>
                </tr>
            </table>
        </div>
